...
detector = cv2.CascadeClassifier("C:/Users/diksha/OneDrive/Desktop/face unlock/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('C:/Users/diksha/OneDrive/Desktop/face unlock/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('C:/Users/diksha/OneDrive/Desktop/face unlock/trainer/')    # Save the model into trainer.yml
recognizer.save('C:/Users/diksha/OneDrive/Desktop/face unlock/trainer/trainer.yml')