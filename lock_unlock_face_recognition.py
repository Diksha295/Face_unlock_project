...
assure_path_exists("C:/Users/diksha/OneDrive//Desktop/face unlock/trainer/")

recognizer.read('C:/Users/diksha/OneDrive//Desktop/face unlock/trainer/trainer.yml')  #load training model

cascadePath = "C:/Users/diksha/OneDrive//Desktop/face unlock/haarcascade_frontalface_default.xml"  #cascade path
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(confidence>80):                 #confidence usually comes greater than 80 for strangers
            ...
            Id = "diksha + {0:.2f}%".format(round(100 - confidence, 2)) 
            print("Verified")
            print(confidence)
            counter_correct += 1
